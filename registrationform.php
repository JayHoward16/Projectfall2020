...
<div class='control block-cube block-input'>
License Number:<input type='text' name='LICENSE_NUMBER' placeholder='License Number' required>
<div class='bg-top'>
<div class='bg-inner'></div>
</div>
<div class='bg-right'>
...
<div class='control block-cube block-input'>
Phone Number:<input type='text' name='PHONE_NUMBER' placeholder='Phone Number' size="10" required>
<div class='bg-top'>
<div class='bg-inner'></div>
</div>
<div class='bg-right'>
...
Street Address:<input type='text' name='STREET' placeholder='Street Address' required>
...
State:<input type='text' name='STATE_NAME' placeholder='State' required>
...
Zip Code:<input type='text' name='ZIPCODE' placeholder='ZipCode' required>
...
<div class='bg-inner'></div>
        ...
        Email:<input type='text' name='EMAIL_ID' placeholder='Email' required>
